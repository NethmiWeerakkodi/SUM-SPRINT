...
<body style="background: url('../Assets/images/bg2.avif') no-repeat center center fixed; background-size: cover;">
    <div class="user-info">
        <p>
            WELCOME TO SUM SPRINT, 
    ...
    <div class="dashboard-container">
        <h1 class="dashboard-title">SUM SPRINT</h1>
